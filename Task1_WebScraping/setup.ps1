...
$Host.UI.RawUI.WindowTitle = "CodeAlpha - Web Scraping - Environment Setup"
$Host.UI.RawUI.ForegroundColor = "Green"

Write-Host "================================================" -ForegroundColor Cyan
Write-Host "    CodeAlpha - Web Scraping" -ForegroundColor Cyan
...
$notebook = Join-Path -Path (Get-Location) -ChildPath "web_scraping.ipynb"
