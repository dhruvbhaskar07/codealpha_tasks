...
$Host.UI.RawUI.WindowTitle = "CodeAlpha - Sentiment Analysis - Environment Setup"
$Host.UI.RawUI.ForegroundColor = "Green"

Write-Host "================================================" -ForegroundColor Cyan
Write-Host "    CodeAlpha - Sentiment Analysis" -ForegroundColor Cyan
...
$notebook = Join-Path -Path (Get-Location) -ChildPath "sentiment_analysis.ipynb"
